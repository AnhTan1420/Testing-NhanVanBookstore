...
try:
    ...
    time.sleep(2)
    driver.find_element(By.NAME, "customer[birthday]").send_keys("22/20/2001")
    driver.find_element(By.NAME, "customer[email]").send_keys("anhtan220@gmail.com")
